...
urlpatterns = [
    ...
    path('updateatt/<str:pk>/',updateatt_view,name='updateatt-view'),
    ...
    path('deactivate/<str:pk>/',deactivate,name='deactivate-view'),
    path('activate/<str:pk>/',activate,name='activate-view'),
    ...
    path('viewatt/',vatt_view,name='vatt-view')
